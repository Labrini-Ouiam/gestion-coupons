...
*/
$sql = "SELECT coupon.*, mark.logo FROM `coupon` INNER JOIN mark ON mark.id_mark = coupon.id_mark";
  ...
  <div class="carousel overflow-hidden flex justify-center items-center relative">
    ...
    <ul class="flex gap-6 justify-center items-center" style="transition: transform 0.5s ease-in-out" id="imageList">
      <li class="w-[12rem] h-[6rem] border drop-shadow-sm hidden">
        <img src="img/logo-2.png" class="w-full h-full object-contain" alt="get best deals image" />
      </li>
      <li class="w-[12rem] h-[6rem] border drop-shadow-sm">
        <img src="img/logo.png" class="w-full h-full object-contain" alt="get best deals image" />
      </li>
      <li class="w-[12rem] h-[6rem] border drop-shadow-sm">
        <img src="img/logo.png" class="w-full h-full object-contain" alt="get best deals image" />
      </li>
...
<div class="flex flex-wrap pt-20 gap-3 justify-center cursor-pointer" id="couponContainer">
    <?php foreach ($coupons as $coupon): ?>
        <a href="other_page.php?id_coupon=<?php echo htmlspecialchars($coupon['id_coupon']); ?>" class="text-decoration-none">
            <div class="border h-full bg-white flex gap-2 pt-4 rounded-md drop-shadow-md hover:bg-slate-100 transition-all duration-500">
                <!-- ... contenu du coupon ... -->
                ...
                <div class="px-4">
                    <span class="font-semibold uppercase text-lg"><?php echo htmlspecialchars($coupon['nom_coupon']); ?></span>
