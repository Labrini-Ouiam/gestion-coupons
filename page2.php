...
<html lang="en">
  <head>
    ...
    <link
      href="https://fonts.googleapis.com/css2?family=Merriweather+Sans:ital,wght@0,400;0,500;0,600;0,700;1,400&family=Noto+Sans:wght@400;500;600;700&family=Roboto+Condensed:wght@400;500;600;700&display=swap"
      rel="stylesheet"
    />
  ...
  <body>
    ...
    <div
      class="w-[40rem] h-[24rem] top[50%] left-[50%] bg-gray-900 z-20 absolute drop-shadow-md rounded-md hidden translate-x-[-50%] translate-y-[30%]"
      id="modal"
    >
      <div class="rounded-md relative">
        <img
          src="img/img2.png"
          alt=""
          class="w-full h-full object-contain rounded-l-md"
        />
        <div
          class="absolute top-0 z-30 w-full h-full flex flex-col items-center"
        >
      ...
      <div class="flex-1 h-full relative">
        <div
          class="absolute w-[1.8rem] h-[1.8rem] right-0 mt-2 mr-2 cursor-pointer"
        >
          <img src="img/ext.svg" alt=" exit button" id="exit1" />
        </div>
        <h1
          class="text-white text-center text-3xl pt-6 tracking-wider font-bold"
        >
          buisnext
        </h1>
        <form action="" class="px-5 pt-5" id="formNewsletter">
          <label class="text-white flex flex-col text-lg font-semibold">
            ...
            <input
              ...
              name="firstName"
              required
              class="rounded-sm text-gray-800 pl-2 mt-2 py-0.5"
            />
          </label>
          ...
          <button
            type="submit"
            class="border text-lg bg-[#FF059B] text-white px-12 py-1 rounded-lg mt-5 w-full hover:bg-pink-600 transition-all duration-500"
          >
            Sign up
          </button>
        </form>
    ...
    <div
      class="w-[40rem] h-[30rem] fixed left-[50%] bg-white z-20 drop-shadow-md rounded-md translate-x-[-50%] translate-y-[30%] flex-col items-center hidden"
      id="modal2"
    >
    ...
    <header class="px-28">
      <nav
        class="flex justify-between py-10 items-stretch capitalize font-bold text-xl tracking-wider"
      >
        <ul class="flex gap-14 list-none">
          <li>
            <a href="index.php" class="hover:text-pink-700 transition-all duration-300"
              >Home</a
            >
          </li>
          <li>
          ...
          <li>
            <a href="page2.php" class="hover:text-pink-700 transition-all duration-300"
              >Brands</a
            >
          </li>
        </ul>
        <div
          class="text-pink-500 cursor-pointer hover:text-black transition-all duration-300"
          id="openModal"
        >
          Newsletter
        </div>
    ...
    <div class="bg-gray-800 w-full h-16">
      <ul class="flex h-full justify-center items-center pr-32">
        <li class="">
          <a
            href="#"
            class="border-2 w-full h-full text-2xl font-bold px-8 py-4 text-white hover:bg-pink-600 transition-all duration-300 ease-in-out uppercase"
            >Dell</a
          >
        </li>
        <li class="">
      ...
      <form action="" class="mt-2">
        <div
          class="bg-white w-1/4 flex items-center justify-between rounded-l-3xl rounded-r-xl absolute right-0 mr-20 drop-shadow-md"
        >
          <input
            class="pl-5 w-full text-lg bg-white rounded-l-3xl py-2 rounded-r-xl"
            placeholder="Search"
          />
    ...
    <section class="py-24 px-28">
      ...
      <p class="pt-6 text-2xl text-slate-600 text-center">
        ...
        aliquid, a autem iste maxime eos voluptate ratione molestiae officia,
        adipisci voluptates distinctio perspiciatis in placeat nam dolorum
        deleniti. Odio, vel?
      </p>
...
<div class="flex flex-wrap pt-20 gap-3 justify-center cursor-pointer" id="markContainer">
            ...
            <div class="flex flex-1">
                <div class="w-[8rem] h-[8rem]">
                    <?php
                        ...
                        $base64Image = base64_encode($mark['logo']);
                    ...
                    ?>
                    <img src="<?php echo htmlspecialchars($dataUri); ?>" class="w-full h-full object-contain" />
                </div>
                <div class="px-4 pt-4">
                    <span class="font-semibold uppercase text-lg"><?php echo htmlspecialchars($mark['nom_mark']); ?></span>
                    type promo est les offre blablabla lore type promo est les offre blablabla lore
                </div>
            </div>

            <!-- You can add buttons or links related to the brand if needed -->
        </div>
    <?php endforeach; ?>
</div>
        ...
        <!-- <div
          class="border h-full bg-white flex items rounded-md drop-shadow-md hover:drop-shadow-lg transition-all duration-500"
        >
          <div class="flex flex-1">
            <div class="w-[8rem] h-[8rem]">
          ...
          <div class="flex w-1/3 items-center justify-center">
            <button
              class="py-2 text-lg font-bold px-9 rounded-md text-white bg-pink-500 drop-shadow-lg hover:bg-pink-600 hover:text-slate-200 hover:px-10 hover:py-3 transition-all duration-500"
            >
              Redeem code
            </button>
          </div>
